...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        {
            return (type == typeof(bool) || type == typeof(sbyte) || type == typeof(byte) || type == typeof(short) ||
                    type == typeof(ushort) || type == typeof(int) || type == typeof(uint) || type == typeof(long) ||
                    type == typeof(ulong) || type == typeof(float) || type == typeof(double) || type == typeof(string));
        }
        #endregion
        ...
        private static object ReadValue (Type inst_type, JsonReader reader)
        {
            ...
            if (reader.Token == JsonToken.Double ||
                ...
                if (inst_type.IsAssignableFrom (json_type))
                    return reader.Value;
                if (IsPrimitiveType(json_type) && IsPrimitiveType(inst_type))
                                        ...
                                        int depth)
        {
            ...
            if (obj is SByte || obj is Byte || obj is Int16 || obj is UInt16 || obj is Int32)
            {
