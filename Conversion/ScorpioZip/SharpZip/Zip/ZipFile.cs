...
//		}
		...
		public void BeginUpdate(IArchiveStorage archiveStorage, IDynamicDataSource dataSource)
		{
            ...
            {
                ZipEntry entry = array[i];
                this.updates_.Add(new ZipFile.ZipUpdate(entry));
                int index = this.updates_.Count - 1;
 ...
 */
		...
		/// </summary>
        class UpdateComparer : IComparer, IComparer<ZipFile.ZipUpdate>
		{
			/// <summary>
            ...
            int IComparer<ZipFile.ZipUpdate>.Compare(ZipFile.ZipUpdate x, ZipFile.ZipUpdate y)
            {
