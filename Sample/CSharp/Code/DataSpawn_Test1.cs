...
namespace scov {
public partial class DataSpawn_Test1 : IData {
    ...
    public static DataSpawn_Test1 Read(string fileName, IScorpioReader reader) {
        var ret = new DataSpawn_Test1();
    ...
    public void Set(DataSpawn_Test1 value) {
        this._ID = value._ID;
