...
public class Msg_C2G_Test : IMessage {
    ...
    private List<__int32> _Value3;
    public List<__int32> getValue3() { return _Value3; }
    public Msg_C2G_Test setValue3(List<__int32> value) { _Value3 = value; AddSign(3); return this; } 
