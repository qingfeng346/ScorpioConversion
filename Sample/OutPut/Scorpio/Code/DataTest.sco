//本文件为自动生成，请不要手动修改
DataTest = [
    { Index = 0, Name = "ID", Type = "int", Array = false },     //测试ID 此值必须唯一 而且必须为int型()
    { Index = 1, Name = "TestInt", Type = "int", Array = false },     //int类型(20)
    { Index = 2, Name = "TestString", Type = "string", Array = false },     //string类型(aaa)
    ...
    { Index = 8, Name = "TestInt3", Type = "Int3", Array = false },     //嵌套类型()
]