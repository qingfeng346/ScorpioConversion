...
//            if (fieldIndex[i] == (int)BasicEnum.CLASS) {
...
//            {
//                string str = "";
//                Element element = Util.GetElement((BasicEnum)fieldIndex[i]);
//                if (element.Type != BasicEnum.CLASS)
...
//            {
//                string str = "";
//                Element element = Util.GetElement((BasicEnum)fieldIndex[j]);
//                if (element.Type != BasicEnum.CLASS)
