...
namespace Scorpio.Conversion.Engine {
    public class ClassField {
        ...
        public bool IsEnum => mParser.IsEnum(Type);             //是否是枚举
        public bool IsClass => mParser.IsClass(Type);           //是否是Class
        public PackageEnum CustomEnum => mParser.GetEnum(Type);
        public PackageClass CustomType => mParser.GetClass(Type);
        ...
        void WriteBasic(TableWriter writer, string value) {
            if (IsBasic) {
                ...
                writer.WriteInt32(mParser.GetEnumValue(Type, value));
            } else {
