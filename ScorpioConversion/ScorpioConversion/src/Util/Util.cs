...
public static class Util {
    ...
    //public static void CreateTableClass(Language language, string fileName, string sheetName, string packageName, string tableClassName, string dataClassName, string md5, List<FieldClass> fields, string path, string fileSuffix) {
    ...
    //    str = str.Replace("__FileName", fileName);
    //    str = str.Replace("__SheetName", sheetName);
    ...
    //    var outFileName = $"{tableClassName}.{suffix}";
    //    if (language == Language.Java) {
    //        outFileName = string.Join("/", packageName.Split(".")) + "/" + outFileName;
    //    }
    //    Scorpio.Commons.FileUtil.CreateFile(outFileName, str, path.Split(Separator));
    //}
